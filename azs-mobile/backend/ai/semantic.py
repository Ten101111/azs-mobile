...
DWH = Semantic(
    ...
    absent=[
        ...
        "формат АЗС / состав сервиса / трасса или город: в витрине ОХД этих атрибутов нет",
        "менеджеры / ТМ / РУ / управляющий: в витрине ОХД нет привязки к людям",
